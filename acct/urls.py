...
from django.urls import path
from .views import (
    UserRegistrationAndProfileCreation,
    UserRegistrationDetailView,
    LogoutView,
    FingerprintUploadView,
    UserProfileView,
...
urlpatterns = [
    ...
    path('registration/', UserRegistrationAndProfileCreation.as_view(), name='registration'),
    path('user-register/', UserRegistrationDetailView.as_view(), name='user-register'),
    path('logout/', LogoutView.as_view(), name='logout'),
    path('upload-fingerprint/<int:artisan_id>/', FingerprintUploadView.as_view(), name='upload-fingerprint'),
    path('user-profile/', UserProfileView.as_view(), name='user-profile'),
    path('password-reset/', PasswordResetRequestView.as_view(), name='password_reset'),
