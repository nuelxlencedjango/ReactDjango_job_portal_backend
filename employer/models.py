...
class Order(models.Model):
    ...
    payment_status = models.CharField(max_length=20, choices=[('failled', 'Failed'),('pending', 'Pending'), ('successful', 'Successful')],default='pending')
    order_status = models.CharField(max_length=20, choices=[('pending', 'Pending'),('in_progress', 'In_Progress'), ('completed', 'Completed')],default='pending')
